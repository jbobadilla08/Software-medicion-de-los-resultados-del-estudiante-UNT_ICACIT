...
public class DashboardProf extends javax.swing.JFrame {
    ...
    public static Profesor admin; //datos del usuario de la cuenta
    ...
    private void identificarUsuario() {
        if (admin.getApellido() != null)
            lblUsuario.setText("Prof. " + admin.getNombre()+" "+admin.getApellido());
        else
            lblUsuario.setText(admin.getNombre());
    }
